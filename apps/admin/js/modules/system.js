...
(function (global) {
  const seed = {
    ...
    menus: [
      ...
      { id: '34', parentId: '3', name: '街道配置', type: '菜单', order: 4, perms: 'drone:street:list', component: 'drone/street/index', status: '正常' },
      { id: '37', parentId: '3', name: '市区配置', type: '菜单', order: 5, perms: 'drone:district:list', component: 'drone/district/index', status: '正常' },
      { id: '35', parentId: '3', name: '飞行活动类型配置', type: '菜单', order: 6, perms: 'drone:activityType:list', component: 'drone/activityType/index', status: '正常' },
