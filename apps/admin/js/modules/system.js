...
(function (global) {
  const seed = {
    ...
    menus: [
      ...
      { id: '24', parentId: '2', name: '执照分类管理', type: '菜单', order: 4, perms: 'drone:licenseType:list', component: 'drone/licenseType/index', status: '正常' },
      ...
      { id: '36', parentId: '3', name: '无人机黑名单', type: '菜单', order: 3, perms: 'drone:droneBlacklist:list', component: 'drone/droneBlacklist/index', status: '正常' },
      ...
      { id: '42', parentId: '4', name: '地址配置', type: '菜单', order: 2, perms: 'drone:address:list', component: 'drone/address/index', status: '正常' },
      { id: '44', parentId: '4', name: '飞行活动类型配置', type: '菜单', order: 3, perms: 'drone:activityType:list', component: 'drone/activityType/index', status: '正常' },
      { id: '5', parentId: '0', name: '活动与宣传科普', type: '目录', order: 5, perms: '', component: '', status: '正常' },
      { id: '51', parentId: '5', name: '活动管理', type: '菜单', order: 1, perms: 'drone:activity:list', component: 'drone/activity/index', status: '正常' },
      { id: '52', parentId: '5', name: '低空安全普法', type: '菜单', order: 2, perms: 'drone:law:list', component: 'drone/law/index', status: '正常' },
      { id: '53', parentId: '5', name: '新闻公告', type: '菜单', order: 3, perms: 'drone:news:list', component: 'drone/news/index', status: '正常' },
      { id: '54', parentId: '5', name: 'Banner 推送', type: '菜单', order: 4, perms: 'drone:banner:list', component: 'drone/banner/index', status: '正常' },
