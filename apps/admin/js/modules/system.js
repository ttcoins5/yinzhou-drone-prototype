...
(function (global) {
  const seed = {
    ...
    menus: [
      ...
      { id: '42', parentId: '4', name: '街道配置', type: '菜单', order: 2, perms: 'drone:street:list', component: 'drone/street/index', status: '正常' },
      { id: '43', parentId: '4', name: '市区配置', type: '菜单', order: 3, perms: 'drone:district:list', component: 'drone/district/index', status: '正常' },
      { id: '44', parentId: '4', name: '飞行活动类型配置', type: '菜单', order: 4, perms: 'drone:activityType:list', component: 'drone/activityType/index', status: '正常' },
